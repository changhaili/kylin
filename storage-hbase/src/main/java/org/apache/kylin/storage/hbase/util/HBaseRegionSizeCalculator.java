...
public class HBaseRegionSizeCalculator {
    ...
    public HBaseRegionSizeCalculator(String tableName, HConnection connection) throws IOException {
        this((HTable)connection.getTable(tableName), new HBaseAdmin(connection));
    }

        /** Constructor for unit testing */
    public HBaseRegionSizeCalculator(HTable table, HBaseAdmin hBaseAdmin) throws IOException {
